...
- What the method do and how it shall do it
...
The part between the braces is the body of the loop and it this part that does the actual work. In this case so will it be checked which of the parameters that is greatest and the value of this parameter is returned to the caller of the method.  
